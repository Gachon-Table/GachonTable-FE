...
export const TableBottomSheet = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex w-full items-end justify-center">
      <div
        className="fixed inset-0 bg-bk/30 opacity-50"
        onClick={onClose}
      ></div>

      <div className="relative z-50 flex w-full max-w-[430px] flex-col rounded-t-[20px] bg-wt px-4 pb-8 pt-6">
