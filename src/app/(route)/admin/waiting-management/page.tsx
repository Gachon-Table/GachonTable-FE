export default function WaitingManagement() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-start bg-deep-cove pt-4">
      ...
      <div className="flex w-full max-w-screen-xl flex-col items-center justify-center px-4 tablet:flex-row">
        <button className="mb-4 w-full rounded-lg bg-sunglo py-3 text-white tablet:mx-2 tablet:mb-0 tablet:flex-1">
          현장 줄서기
        </button>
        <button className="w-full rounded-lg bg-sunglo py-3 text-white tablet:mx-2 tablet:flex-1">
          대기 마감
        </button>
      </div>
    </div>
