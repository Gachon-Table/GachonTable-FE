...
const AlertModal: React.FC<AlertModalProps> = ({ message, onCancel }) => {
  return (
    <div className="fixed left-0 top-0 z-50 flex h-full w-full items-center justify-center">
      <div className="flex flex-col items-center justify-center rounded-lg bg-gray-200 p-6 shadow-lg">
        ...
        <div className="mt-4 flex items-center justify-center space-x-4">
          ...
          <button className="rounded-lg bg-blue-500 px-5 py-3 text-sm font-light text-white shadow-md hover:bg-blue-600">
