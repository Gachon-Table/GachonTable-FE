...
const Profile = () => {
  ...
  return (
    <div className="flex items-center justify-center px-4">
      <div className="p-safe-bottom flex w-[382px] flex-col  gap-[10px] text-gy-400 font-b1-normal-medium">
        <button
          className="flex h-[64px] w-full cursor-pointer items-center justify-center rounded-[6px] bg-kakao px-6 py-[22px] text-bk font-h4"
