  ...
  return (
    <div className="absolute my-auto h-full w-full max-w-[500px]">
      <div className="flex h-full w-full items-center justify-center" onClick={() => setModal(false)}>
        <div onClick={(e) => {e.stopPropagation()}} className="flex h-[30vh] w-[80%] flex-col items-center justify-center gap-2 rounded-[0.5rem] border-2 bg-white border-gray-300 py-4">
